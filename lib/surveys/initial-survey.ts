...
export const initialSurvey: Survey = {
  ...
  title: "Tu opinión puede ayudarnos a construir un mejor Psico Care",
  ...
  questions: [
    ...
    choice("previous-use", "Antes de conocer Psico Care, ¿habías utilizado alguna herramienta digital de bienestar emocional?", ["Sí, frecuentemente", "Sí, algunas veces", "La he probado una vez", "No"]),
    scale("willingness", "¿Qué tan dispuesto/a estarías a utilizar una aplicación como Psico Care?", 5, "Nada dispuesto/a", "Muy dispuesto/a"),
    choice("frequency", "¿Con qué frecuencia crees que utilizarías Psico Care?", ["Todos los días", "Varias veces por semana", "Una vez por semana", "Algunas veces al mes", "Solo cuando lo necesitara", "Probablemente no la usaría"]),
    ...
    choice("concern", "¿Qué aspecto te generaría mayor preocupación al utilizar Psico Care?", ["Privacidad de mis datos", "Que la IA entienda mal lo que digo", "No saber quién revisa el contenido", "Que sustituya la ayuda profesional", "No saber cómo funciona", "No me genera preocupación", "Otro"]),
    scale("try-score", "Después de conocer la propuesta, ¿qué tan probable sería que probaras Psico Care?", 10, "Nada probable", "Muy probable"),
    scale("recommendation", "Si Psico Care estuviera disponible hoy, ¿qué tan probable sería que la recomendaras a alguien de tu edad?", 10, "Nada probable", "Muy probable"),
    { id: "must-have", title: "¿Qué tendría que ofrecer Psico Care para que realmente quisieras utilizarla?", type: "text", required: false, description: "Comparte ideas sobre el producto. Evita nombres, datos de contacto, diagnósticos o experiencias personales sensibles.", config: { maxLength: 500 }, options: [] },
