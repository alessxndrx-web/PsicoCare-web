...
export function AppDemo() {
  ...
  return <section className="demo-section section-space" id="app-movil"><Container>
    <div className="demo-layout"><div className="demo-copy"><SectionHeading eyebrow="La app, en tus manos" title={<>Conócela.<br/>Tócala. Explórala.</>}>Descubre cómo un pequeño momento para ti puede convertirse en un primer paso.</SectionHeading>
