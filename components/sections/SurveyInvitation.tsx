...
export function SurveyInvitation() {
  return <section className="survey-invitation section-space" id="encuestas"><Container><div className="survey-invitation-card">
    <div><Eyebrow>Lo construimos contigo</Eyebrow><h2>Tu opinión construye<br/>un mejor PsicoCare.</h2><p>Las mejores herramientas empiezan por escuchar. Cuéntanos qué te sería útil y ayúdanos a decidir qué construir primero.</p>
