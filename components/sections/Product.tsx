...
export function Product() {
  return <section className="product-intro section-space" id="producto"><Container>
    <div className="split-heading"><SectionHeading eyebrow="Esto es PsicoCare" title={<>Más espacio para ti. <br/>Más formas de avanzar.</>}/><p>Una aplicación de acompañamiento emocional para jóvenes. Conversa, reflexiona y practica situaciones cotidianas en un mismo espacio, con límites claros y a tu ritmo.</p></div>
