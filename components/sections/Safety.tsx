...
export function Safety() {
  return <section className="safety-section section-space" id="seguridad"><Container><div className="safety-layout">
    <div><span className="safety-symbol"><Icon name="shield" size={52}/></span><SectionHeading eyebrow="Tu confianza, primero" title={<>Tecnología con <br/>límites claros.</>}>Acompañar también significa reconocer hasta dónde llegar. Ese principio está en el centro de Psico Care.</SectionHeading><ButtonLink href="/seguridad" variant="ghost">Conocer nuestro compromiso</ButtonLink></div>
    <div className="safety-principles">{[
      ...
      ["shield", "Sin diagnósticos", "Psico Care no diagnostica ni sustituye la atención de profesionales de salud mental."],
