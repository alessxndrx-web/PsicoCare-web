...
export const metadata: Metadata = {
  title: "Psico Care para educación",
  description: "Psico Care es gratuito para los estudiantes. Universidades, colegios e institutos incorporan una capa institucional para desplegar programas de bienestar, organizarlos y conocer su adopción mediante información agregada.",
  ...
  return <>
    <section className="edu-hero"><Container>
      <div className="edu-hero-grid">
        <div><Eyebrow>Psico Care para educación</Eyebrow><h1>Psico Care para tu comunidad educativa.</h1>
        ...
        <Image src="/brand/mascots-together.webp" width={300} height={300} alt="Los personajes de Psico Care acompañándose" priority/>
      </div>
      <p className="edu-promise"><Icon name="heart" size={20}/>{FREE_PROMISE}</p>
    </Container></section>

    <section className="section-space" id="modelo"><Container>
      <SectionHeading eyebrow="Cómo funciona el modelo" title={<>Más herramientas para la institución. <br/>La misma privacidad para el estudiante.</>}>Si cualquier joven ya puede usar Psico Care gratis, ¿qué incorpora una institución? No una versión mejor de la app: la infraestructura para desplegar, organizar, medir y sostener sus iniciativas de bienestar.</SectionHeading>
      <div className="compare-grid">
        <article className="compare-card is-free">
          <div className="compare-head"><Eyebrow>Para cualquier joven</Eyebrow><h3>Psico Care gratis</h3><p>La experiencia personal completa, sin pertenecer a ninguna institución y sin pagar.</p></div>
        ...
        <article className="compare-card is-institutional">
          <div className="compare-head"><Eyebrow>Para la institución</Eyebrow><h3>Psico Care Educación</h3><p>Todo lo que ya reciben las personas, más una capa institucional para acompañar mejor a la comunidad.</p></div>
      ...
      <div className="privacy-callout"><Icon name="shield" size={26}/><div><h3>{PRIVACY_PROMISE}</h3>
        ...
        <p className="privacy-account">La cuenta de Psico Care pertenece a la persona. Pertenecer a una institución añade programas, recursos y encuestas; si deja de pertenecer, conserva su experiencia personal.</p></div></div>
    </Container></section>

    <section className="moments-section section-space"><Container>
      <SectionHeading eyebrow="Momentos de la vida estudiantil" title="Psico Care puede acompañar distintos momentos del curso.">La propuesta no es abstracta: estos son los momentos donde una institución puede apoyarse en la plataforma.</SectionHeading>
    ...
    <section className="surveys-edu-section section-space"><Container>
      <div className="surveys-edu"><div><Eyebrow>Encuestas institucionales</Eyebrow><h2>Escucha a tu comunidad sin convertir cada respuesta en un expediente.</h2>
        ...
        <Image src="/brand/mascot-tangled.webp" width={150} height={199} alt="El personaje enredado de Psico Care escucha" loading="lazy"/></div>
    </Container></section>

    <section className="plans-section section-space" id="programas"><Container>
      <SectionHeading eyebrow="Formas de implementarlo" title="Elige el punto de partida.">Tres maneras de incorporar Psico Care a una institución educativa, según el momento en el que estés.</SectionHeading>
    ...
    <section className="section-space"><Container>
      <SectionHeading eyebrow="Más allá de la implementación" title="También podemos colaborar.">No toda relación con Psico Care es un programa contratado. Estas vías son de colaboración y no implican costo.</SectionHeading>
