...
export default function Page() {
  return <DocumentPage eyebrow="Tu confianza, primero" title="Acompañar también es saber hasta dónde llegar." lead="Queremos que siempre puedas distinguir lo que PsicoCare puede ofrecerte y cuándo el siguiente paso necesita ser humano.">
    <h2>Una primera capa de acompañamiento</h2><p>PsicoCare no diagnostica condiciones de salud mental ni reemplaza la atención profesional. Las herramientas y ejemplos de esta web permiten explorar el producto; no son una consulta ni un tratamiento.</p>
    ...
    <h2>El apoyo humano es esencial</h2><p>Puedes considerar hablar con alguien de confianza o buscar a un profesional de salud mental. La red profesional de PsicoCare sigue en desarrollo: la web no agenda consultas, inicia derivaciones ni contacta a profesionales por ti.</p>
