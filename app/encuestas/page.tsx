...
export const metadata: Metadata = { title: "Construyamos Psico Care", description: "Participa voluntariamente en la encuesta de validación de Psico Care. Anónima por defecto y para mayores de 18 años; al final puedes dejar tu correo si quieres.", alternates: { canonical: "/encuestas" } };
