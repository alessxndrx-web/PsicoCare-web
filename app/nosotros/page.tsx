...
export default function Page() {
  return <DocumentPage eyebrow="De Nicaragua, con propósito" title="Tecnología que acompaña. Personas que importan." lead="PsicoCare nace al reconocer que hay jóvenes que recurren a la tecnología para expresar lo que sienten. Queremos que ese primer paso tenga un espacio diseñado con responsabilidad.">
    ...
    <h2>Construir escuchando</h2><p>Queremos aprender de jóvenes, profesionales, instituciones y organizaciones. No presentamos alianzas, resultados clínicos ni cifras de adopción que aún no existen.</p><ButtonLink href="/#contacto">Conversemos sobre PsicoCare</ButtonLink>
  </DocumentPage>;
}
